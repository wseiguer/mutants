 ...
 * arrays to keep minimize the memory footprint. Implements only the operations
 * that are needed within the suffix tree context.
 */
class EdgeBag implements Map<Character, Edge> {
    ...
    /**
     * A trivial implementation of sort, used to sort chars[] and values[] according
     * to the data in chars.
     * 
     * It was preferred to faster sorts (like qsort) because of the small sizes
     * (<=36) of the collections involved.
     */
