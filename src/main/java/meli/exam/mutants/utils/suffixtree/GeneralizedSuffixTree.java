...
/**
 * A Generalized Suffix Tree, based on the Ukkonen's paper "On-line construction
 * of suffix trees" http://www.cs.helsinki.fi/u/ukkonen/SuffixT1withFigs.pdf
 *
...
public class GeneralizedSuffixTree {
    ...
    private Node searchNode(String word) {
         ...
         * of all the labels on the path is a superstring of the given word. If such a
         * path is found, the last node on it is returned.
         */
    ...
    /**
     * Return a (Node, String) (n, remainder) pair such that n is a farthest
     * descendant of s (the input node) that can be reached by following a path of
     * edges denoting a prefix of inputstr and remainder will be string that must be
     ...
     * contains a collection of results and the total number of results present in
     * the GST.
     * 
